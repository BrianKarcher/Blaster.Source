...
namespace BlueOrb.Controller.Player
{
    ...
    [AddComponentMenu("BlueOrb/Components/Player Controller")]
    ...
    public class PlayerController : ComponentBase<PlayerController>
    {
        ...
        protected override void Awake()
        {
            ...
            if (sceneSetup != null && sceneSetup.StartPosition != null)
            {
                Debug.Log($"Setting player start position to {sceneSetup.StartPosition.transform.position}");
                characterController = GetComponent<CharacterController>();
                this.characterController.enabled = false;
                this.transform.position = sceneSetup.StartPosition.transform.position;
                this.transform.rotation = sceneSetup.StartPosition.transform.rotation;
